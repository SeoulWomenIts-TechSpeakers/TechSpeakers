...
| 2025.03.02(일) <br>오후 2시      | 1차 아티클 발표                                         | - **2025.03.01(토)** 자정까지 아티클 업로드 <br>- 깃 링크 첨부 | 복합한옥공간 곳 공간 대여                                   |
| 2025.03.15(토) <br>오후 2시 <br> | 2차 아티클 발표                                         | - **2024.03.15(토)** 자정까지 아티클 업로드 <br>- 깃 링크 첨부 | 서울광역청년센터(용산) 대여                       |
| 2025.03.29(토) <br>오후 2시<br>  | 3차 아티클 발표                                         | - **2025.03.29(토)** 자정까지 아티클 업로드 <br>- 깃 링크 첨부 |  서울광역청년센터(용산) 대여 예정                       |
| 2025.04.12(토) <br>오후 2시      | 최종 프리젠테이션 발표회 <br>- 10-15분 내에 성과물 발표 | **2024.04.11(금)** 리더에게 프리젠테이션 메일로 전송           | 여성가족플라자 대관 완료 |
